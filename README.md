...
A tape player for ZX Spectrum tape images — TZX, TAP, PZX, and CSW — built on libspectrum. Adds the transport controls of a real tape player (pause, rewind to previous block, bookmarks, jump-to-block) and variable playback speed.
